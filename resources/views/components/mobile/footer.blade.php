<footer class="bg-[#1AD0D0] p-4 mt-10">
    <div class="flex items-center justify-between">
        <img class="w-auto h-10" src="/assets/img/psychiatry/cs-logo-white.png" alt="cepat sehat logo" />
        <img class="w-auto h-10" src="/assets/img/psychiatry/atensi-logo.png" alt="atensi logo" />
    </div>

    <div class="mt-4 text-white font-light text-sm">
        <p>Our pharmacy delivery service is powered by Clinic Cepat Sehat (Reg. No. 04102100035090001), your trusted partner in healthcare. We provide integrated healthcare solutions, including home care, online consultations, and reliable home check lab.</p>
        <p class="mt-2">🛵 Experience hassle-free service with medications delivered right to your door, 24/7.</p>
        <p class="mt-2">Our online pharmacy partners across Bali ensure trusted, delivery-only services. Explore our Google Map comments and ratings below.</p>
    </div>
    ...
    <div class="flex items-center justify-between mt-4">
        <div class="flex items-center gap-2">
            <img class="w-8 h-8" src="/assets/img/psychiatry/whatsapp-icon.png" alt="whatsapp-icon" />
            <p class="text-sm text-white">+6282221122311</p>
        </div>
        <div class="flex items-center gap-2">
            <img class="w-8 h-8" src="/assets/img/psychiatry/facebook-icon.png" alt="facebook-icon" />
            <img class="w-8 h-8" src="/assets/img/psychiatry/instagram-icon.png" alt="instagram-icon" />
        </div>
    </div>
</footer>
<div class="bg-white text-center text-sm py-2">
    Copyright © 2024 Cepat Sehat Bali. All Rights Reserved.
</div>